...
const descriptionTemplate = `<h4>Thông tin sản phẩm</h4>
...
export default function Products() {
  ...
  return (
    <div className="stack page-products">
      ...
      {showDialog && (
        <div className="product-dialog-backdrop" onClick={closeDialog}>
          <div className="product-dialog" onClick={(e) => e.stopPropagation()}>
            <div className="product-dialog-header">
              <div>
                <p className="eyebrow">{editing ? "Chỉnh sửa sản phẩm" : "Thêm sản phẩm mới"}</p>
                <h3>{editing ? form.name || "Sản phẩm" : "Tạo sản phẩm"}</h3>
              </div>
              <button type="button" className="product-dialog-close" onClick={closeDialog}>
                ×
              </button>
            </div>

            <form className="form-grid form-grid-wide product-dialog-form" onSubmit={submit}>
              <label>
                Tên sản phẩm
              ...
              <div className="full dialog-actions">
                <button className="btn btn-primary" disabled={saving} type="submit">
                  {saving ? "Đang lưu..." : editing ? "Cập nhật sản phẩm" : "Thêm"}
                </button>
